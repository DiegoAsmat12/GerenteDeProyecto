...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<form:form method="post" action="/projects/${proyecto.getId()}" modelAttribute="proyecto">
				...
				<form:hidden path="id" value="${proyecto.getId()}"/>
				...
				<div class="d-flex">
					...
					<button type="submit" class="btn btn-primary ms-3">Editar</button>
				</div>
			</form:form>
		</div>
